...
//                Picasso.get().load(model.getProductPicUrl()).into(holder.productImage);
                Picasso.with(ProductInfo.this).load("http://msitmp.herokuapp.com"+ model.getProductPicUrl()).into(holder.productImage);
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(ProductInfo.this, productDetails.class);
